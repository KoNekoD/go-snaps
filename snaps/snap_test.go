...
func setupTempExamineFiles(
	...
	tests := map[string]int{
		files[0].name + "TestDir1_1/TestSimple": 1,
		files[0].name + "TestDir1_2/TestSimple": 1,
		files[0].name + "TestDir1_3/TestSimple": 2,
		files[0].name + "TestCat":               1,
		files[0].name + "TestAlpha":             2,
		files[0].name + "TestBeta":              1,
		files[1].name + "TestDir2_1/TestSimple": 3,
		files[1].name + "TestDir2_2/TestSimple": 1,
		files[1].name + "TestCat":               1,
		files[1].name + "TestAlpha":             2,
		files[1].name + "TestBeta":              1,
	}
...
func TestExamineSnaps(t *testing.T) {
	t.Run("should report no obsolete snapshots", func(t *testing.T) {
		...
		used := []string{
			filepath.FromSlash(dir1 + "_test1.snap"),
			filepath.FromSlash(dir2 + "_test2.snap"),
		}
